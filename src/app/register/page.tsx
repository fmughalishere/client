            ...
            >
              ...
              <div className="space-y-4">
                <button 
                  ...
                  className="w-full py-4 bg-[#00004d] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 shadow-lg active:scale-95 transition-transform"
                >
                  Go to Login <ArrowRight size={18} />
                </button>
                <button 
                  onClick={() => setIsEmailSent(false)}
                  className="text-gray-400 font-bold text-[10px] uppercase tracking-[0.2em] hover:text-[#00004d] transition-colors"
                >
