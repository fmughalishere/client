  ...
  return (
    <main className="min-h-screen bg-[#fcfcfc] pb-10">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            Get In <span className="text-[#5DBB63]">Touch</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 md:mt-20">
        <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="bg-[#00004d] p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] text-white relative overflow-hidden shadow-2xl">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#5DBB63]/10 rounded-bl-full blur-2xl"></div>
              <h3 className="text-xl font-black mb-6 relative z-10  tracking-widest">
                Follow Us
              </h3>
              <div className="flex gap-4 relative z-10">
                {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                  <button key={i} className="w-10 h-10 md:w-12 md:h-12 bg-white/10 hover:bg-[#5DBB63] hover:text-[#00004d] rounded-2xl flex items-center justify-center transition-all active:scale-90">
                    <Icon size={20} />
                  </button>
                ))}
              </div>
              ...
              {formState === "success" ? (
                ...
                >
                  <div className="w-20 h-20 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-8">
                    <CheckCircle2 size={48} className="text-[#5DBB63]" />
                  </div>
                ...
                <>
                  <div className="mb-10">
                    <h2 className="text-2xl md:text-3xl font-black text-[#00004d] mb-2 flex items-center gap-3">
                      <MessageSquare className="text-[#5DBB63]" /> Send Message
                    </h2>
