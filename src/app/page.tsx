      ...
      <section className="max-w-2xl mx-auto px-6 mt-10 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
          {quickActions.map((action, i) => (
            ...
            >
              <div className="relative flex flex-col items-center justify-center h-[120px] bg-white rounded-2xl text-[#00004d] shadow-md border border-gray-50 p-3">                <div className="mb-3 transform group-hover:scale-110 transition-transform">
                {action.icon}
              </div>
