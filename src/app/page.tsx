...
export default function HomePage() {
  ...
  return (
    <main className="h-screen w-full bg-[#fcfcfc] flex flex-col overflow-hidden">
      <section className="relative">
        <div className="pt-2 px-6 flex flex-col items-center">
        ...
        <div
          className="relative flex justify-center px-6 mt-2 z-30"
          ref={searchRef}
        >
          <div className="relative w-full max-w-[300px]">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-4 gap-2">
              ...
              <button
                ...
                className="text-[#00004d] font-black text-[15px]"
              >
                Go
              </button>
            </div>
              ...
              <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden text-left">
                {suggestions.map((item, idx) => (
                  <div
                    ...
                    className="px-4 py-2 flex items-center gap-3 hover:bg-gray-100 cursor-pointer border-b last:border-none border-gray-50"
                  >
