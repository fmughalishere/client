  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8 md:py-16 px-4 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <Link href="/cities" className="inline-flex items-center gap-2 text-gray-400 font-black mb-8 hover:text-[#000a31] transition-all text-[10px] md:text-xs  tracking-widest">
        ...
        <div className="bg-[#000a31] p-8 md:p-20 rounded-[2.5rem] md:rounded-[5rem] shadow-2xl mb-12 relative overflow-hidden text-white">
          ...
          <div className="relative z-10">
            <motion.div 
              ...
              className="flex items-center gap-2 text-[#00d26a] font-black  tracking-widest text-[9px] md:text-xs mb-4"
            >
        ...
        <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
            ...
            {jobs.length > 0 ? (
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div className="flex items-center gap-4 md:gap-6 w-full">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-3 md:gap-4 text-gray-400 font-bold text-[10px] md:text-xs  tracking-wider">
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-4 w-full md:w-auto pt-4 md:pt-0 border-t md:border-none border-gray-50">
                      <div className="text-left md:text-right md:mr-4">
                        ...
                        <div className="text-[9px] font-bold text-gray-300  tracking-tighter">Per Month</div>
                      </div>
              ...
              <div className="bg-white p-12 md:p-20 rounded-[3rem] text-center border-2 border-dashed border-gray-100">
                ...
                <h3 className="text-lg md:text-2xl font-black text-[#000a31] mb-2  tracking-tight">No Vacancies Yet</h3>
          ...
          <aside className="lg:col-span-1 space-y-8 mt-12 md:mt-0">
             <div className="bg-[#000a31] p-8 md:p-10 rounded-[2.5rem] md:rounded-[4rem] text-white shadow-2xl relative overflow-hidden">
                ...
                <h3 className="text-lg md:text-xl font-black mb-4 relative z-10  tracking-widest text-[#00d26a]">Job Alerts</h3>
                ...
                <button className="w-full bg-[#00d26a] text-[#000a31] font-black py-4 rounded-full shadow-lg hover:bg-white transition-all active:scale-95  text-xs tracking-widest">
                  Subscribe
                </button>
             </div>
             <div className="bg-white p-8 md:p-10 rounded-[2.5rem] md:rounded-[4rem] border border-gray-100 shadow-sm">
                <h3 className="text-md md:text-lg font-black text-[#000a31] mb-8  tracking-widest border-b pb-4 border-gray-50">Top Cities</h3>
