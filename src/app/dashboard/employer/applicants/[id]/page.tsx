          ...
          <div className="bg-white w-full max-w-lg rounded-[45px] overflow-hidden shadow-2xl relative">
            ...
            <form onSubmit={handleFormSubmit} className="p-8 space-y-6 max-h-[75vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[13px] font-black text-[#00004d] ml-1">City Name</label>
                  <input required name="cityName" value={offerData.cityName} onChange={handleInputChange} className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-[#00004d] text-sm font-bold outline-none" placeholder="Enter City Name" />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  <label className="text-[13px] font-black text-[#00004d] ml-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-[#00004d] text-sm font-bold outline-none font-sans"
                  />
                </div>
              </div>
              <div className="pt-6">
